...
const questions = [
  ...
  },
  {
    ...
    options: ["Muito sol", "Chuva", "Muito calor", "Tempo seco"],
    correctAnswer: 1
  },
  {
    question: "Qual era a minha “matéria favorita” na escola?",
    options: ["Matemática", "História", "Educação Física", "Acabar a aula"],
    correctAnswer: 3
  },
  {
  ...
  },
  {
    ...
    options: ["Honda", "Toyota", "Peugeot", "Chevrolet"],
    correctAnswer: 2
  },
  {
  ...
  },
  {
    ...
    options: ["Feijão", "Salada", "Peixe", "Macarrão"],
    correctAnswer: 0
  },
  {
...
const reviewRestartButton = document.getElementById(
...
function renderQuestion({ animate = true } = {}) {
  ...
  const updateContent = () => {
    ...
    questionNumberBadge.textContent = String(currentNumber).padStart(2, "0");
